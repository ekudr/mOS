...
struct sdhci_ops {
	...
	int (*platform_execute_tuning)(struct sdhci_host *host, u8 opcode);
...
kerrno_t sdhci_setup_cfg(struct mmc_config *cfg, struct mmc_host *host, uint32_t f_max, uint32_t f_min);
